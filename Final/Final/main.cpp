...
int main()
{
	...
	// ------------------------------------
	Shader shader1("camera.vs", "camera.fs");
	Shader shader2("texture.vs", "texture.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		float radius = 10.0f;
		float camX = sin(camera_rotate) * radius;
		float camZ = cos(camera_rotate) * radius;
		...
		for (unsigned int i = 0; i < 2; i++)
		{
			...
			model1 = glm::translate(model1, cubePositions1[i]);
		...
		//view2 = glm::lookAt(glm::vec3(0.0f, 0.0f, radius), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model2 = glm::translate(model2, cubePositions2[0]);
