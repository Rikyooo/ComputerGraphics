...
"void main()\n"
"{\n"
"   FragColor = vec4(0.6f, 0.2f, 1.0f, 1.0f);\n"
"}\n\0";
...
int main()
{
	...
	unsigned int fragmentShaderPurple = glCreateShader(GL_FRAGMENT_SHADER); // the third fragment shader that outputs the color purple
	unsigned int shaderProgramOrange = glCreateProgram();
	unsigned int shaderProgramYellow = glCreateProgram(); // the second shader program
	unsigned int shaderProgramPurple = glCreateProgram(); // the third shader program
	...
	glShaderSource(fragmentShaderPurple, 1, &fragmentShader3Source, NULL);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_TRIANGLES, 0, 3);	// this call should output a purple triangle
